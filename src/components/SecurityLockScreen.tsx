...
export default function SecurityLockScreen({ onUnlock, lockReason }: SecurityLockScreenProps) {
    ...
    return (
        <GradientBackground variant="auto" className="fixed inset-0 z-50 overflow-y-auto overscroll-contain">
            <div className="min-h-screen px-4 py-8 flex flex-col justify-center">
                <div className="w-full">
                    <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-5 sm:p-8 w-full max-w-md mx-auto">
                        {/* Theme Toggle Button */}
                        ...
                        </div>                    {/* Active Wallet Info */}
                        {activeWallet && (
                            <div className="mb-5 p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border">
                            ...
                            <div className="mb-5">
                                <div className="flex flex-col gap-2">
                                    <button
                                        ...
                                        className="w-full flex items-center justify-center px-3 py-2.5 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white rounded-lg transition-colors"
                                    >
                                        {getBiometricIcon()}
                                    ...
                                    <button
                                        ...
                                        disabled={isLoading}
                                        className="text-sm text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 flex items-center justify-center transition-colors py-1.5"
                                    >
